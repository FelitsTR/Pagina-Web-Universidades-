        ...
        <div class="portfolio-description">
          ...
          <div id="carrera1">
            <div id="carrera1-muestra">
              ...
              <?php
                $consulta="SELECT carrera FROM oferta_educativa WHERE id_universidad='$iduni' AND id_oferta='1'";
                $ejecutar=mysqli_query($conexion,$consulta) or die ("Error en la consulta a la base de datos x1");
                $columna=mysqli_fetch_array($ejecutar);
            ...
            <div id="carrera2-muestra">
              ...
              <?php
                $consulta="SELECT carrera FROM oferta_educativa WHERE id_universidad='$iduni' AND id_oferta='2'";
                $ejecutar=mysqli_query($conexion,$consulta) or die ("Error en la consulta a la base de datos x1");
                $columna=mysqli_fetch_array($ejecutar);
